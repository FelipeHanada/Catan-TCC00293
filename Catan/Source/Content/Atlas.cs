...
namespace Catan.Source.Content
{
    ...
    public class Atlas
    {
        ...
        private static readonly Dictionary<AtlasSpriteId, Rectangle> _spriteRectangles = new()
        {
            ...
            [AtlasSpriteId.CityPlayer1] = new Rectangle(0, 160, 32, 48),
            ...
            [AtlasSpriteId.CityPlayer2] = new Rectangle(32, 160, 32, 48),
            ...
            [AtlasSpriteId.CityPlayer3] = new Rectangle(64, 160, 32, 48),
            ...
            [AtlasSpriteId.CityPlayer4] = new Rectangle(96, 160, 32, 48),
            ...
            [AtlasSpriteId.DevCardInvention] = new Rectangle(0, 208, 127, 192),
            [AtlasSpriteId.DevCardRoad] = new Rectangle(127, 208, 127, 192),
            [AtlasSpriteId.DevCardMonopoly] = new Rectangle(254, 208, 127, 192),
            [AtlasSpriteId.DevCardKnight] = new Rectangle(381, 208, 127, 192),
            [AtlasSpriteId.DevCardVP] = new Rectangle(508, 208, 127, 192),
            ...
            [AtlasSpriteId.WoolTradePopup] = new Rectangle(5, 544, 69, 89),
            [AtlasSpriteId.WheatTradePopup] = new Rectangle(85, 544, 69, 89),
            [AtlasSpriteId.OreTradePopup] = new Rectangle(165, 544, 69, 89),
            [AtlasSpriteId.BrickTradePopup] = new Rectangle(245, 544, 69, 89),
            [AtlasSpriteId.WoodTradePopup] = new Rectangle(325, 544, 69, 89),
            [AtlasSpriteId.UniversalTradePopup] = new Rectangle(405, 544, 69, 89),
